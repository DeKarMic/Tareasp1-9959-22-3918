...
const int NUMERO_ALUMNOSInge = 10;
const int NUMERO_MATERIASInge =4;
const int MAX_CALIFICACIONInge = 100;
...
const int NUMERO_ALUMNOSAdmi = 10;
const int NUMERO_MATERIASAdmi =4;
const int MAX_CALIFICACIONAdmi = 100;
...
int main()
{
    cout<<"\n\t*******Bienvenidos al programa de la universidad****";
    cout<<" "<<endl;

    do {
    cout<<"Que facultad desea calcular?";
    cout<<" "<<endl;
    cout<<"\n\t     1. Facultad de ingenieria";
    cout<<"\n\t     2. Facultad de Arquitectura";
    cout<<"\n\t     3. Facultad de Administracion";
    cout<<"\n\t     4. Calcular promedio de todas";
    ...
    char alumnosInge[NUMERO_ALUMNOSInge][MAXIMA_LONGITUD_CADENAInge] = {"Jorge","Alex", "Monica", "Jhonatan", "Melissa", "Allan", "Julio", "Jesicca", "Joseph", "Natalie"};
 ...
 srand(getpid());
    ...
    char alumnos[NUMERO_ALUMNOS][MAXIMA_LONGITUD_CADENA] = {"Luis","Fernando", "Ana", "Elizabeth", "Esteban", "Gloria", "Dana", "Michelle", "Juan Carlos", "Berny"};
    llenarMatriz(matriz);
 ...
 srand(getpid());
    ...
    char alumnosAdmi[NUMERO_ALUMNOSAdmi][MAXIMA_LONGITUD_CADENAAdmi] = {"Luis","Fernando", "Ana", "Elizabeth", "Esteban", "Gloria", "Dana", "Michelle", "Juan Carlos", "Berny"};
...
void imprimirMatrizInge(float matrizInge[NUMERO_ALUMNOSInge][NUMERO_MATERIASInge + 1], char alumnosInge[NUMERO_ALUMNOSInge][MAXIMA_LONGITUD_CADENAInge])
{
    ...
    cout << "Promedio mayor: " << setw(10) << alumnoPromedioMayorInge << " Nota: " << setw(10) << promedioMayorInge << endl;
    cout << "Promedio menor: " << setw(10) << alumnoPromedioMenorInge << " Nota: " << setw(10) << promedioMenorInge << endl;
}
...
void imprimirMatrizAdmi(float matrizAdmi[NUMERO_ALUMNOSAdmi][NUMERO_MATERIASAdmi + 1], char alumnosAdmi[NUMERO_ALUMNOSAdmi][MAXIMA_LONGITUD_CADENAAdmi])
{
    ...
    cout << "Promedio mayor: " << setw(10) << alumnoPromedioMayorAdmi << " Nota: " << setw(10) << promedioMayorAdmi << endl;
    cout << "Promedio menor: " << setw(10) << alumnoPromedioMenorAdmi << " Nota: " << setw(10) << promedioMenorAdmi;
}
